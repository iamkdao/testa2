[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/AlvpkHWx)
Assignment 2 - Client Server: Basic Two-tier Web Application using HTML/CSS/JS and Node.js or Express.js
===

Due: T 2-3 at 11:59pm. 10 points off if submitted by W 2-4 at noon.

This assignment will introduce you to creating a prototype two-tiered, client-server web application.
Your application will include the use of HTML, CSS, JavaScript, and Node.js or Express.js functionality, with active communication between the client and the server.
...
- An HTTP Server that delivers all necessary files and data for the application, and also creates the required Derived Fields in your data.
  A starting point is provided in this repository but you may replace the code and use Express.js if you prefer.
...
4. (5 pts) Deploy your project using Render or AWS
5. (5 pts) Ensure that your project has the proper naming scheme `a2-LastNameFirstName` so we can find it.
...
LastName, FirstName: Render or AWS link
